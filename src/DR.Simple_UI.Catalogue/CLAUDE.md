...
This site is an application built with DR.Simple_UI, not a site describing one. Its shell, sidebar,
...
- **Single source of CSS.** The app serves `_content/DR.Simple_UI/…`, never a copy. `HostPageTests`
