...
internal sealed class CatalogueTools(CatalogueIndex index, VersionEnvelope versions)
{
    ...
    [Description("""
        Search the DR.Simple_UI catalogue for examples, CSS classes, design tokens and pages.
    ...
    public object Search(
        ...
        int limit = 10,
        [Description("The DR.Simple_UI version your app has installed, e.g. \"0.2.0\". "
    ...
    public object GetExample(
        ...
        string[] ids,
        [Description("The DR.Simple_UI version your app has installed.")]
        string? installedVersion = null)
    {
    ...
    [Description("""
        How to wire DR.Simple_UI into an app: the host page with its load order, the branding
