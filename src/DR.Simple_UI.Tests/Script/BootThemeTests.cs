...
public class BootThemeTests : ScriptTestBase
{
    ...
    {
        if (NoBrowser) return;
        const string tag = """<script src="/js/DR.Simple_UI.boot.js" data-theme-default="system"></script>""";
    ...
    {
        if (NoBrowser) return;
        const string tag = """<script src="/js/DR.Simple_UI.boot.js" data-theme-default="light"></script>""";
